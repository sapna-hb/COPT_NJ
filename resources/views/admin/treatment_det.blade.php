...
<body class="hold-transition sidebar-mini layout-fixed" data-page="show-therapydet">
    <div class="wrapper">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Therapy Details List</h3>
                                    <a href="{{ route('admin.therapyDetailAdd') }}"
    ...
    <script>
        var therapyTable = '{{ route('admin.therapyDetailList') }}';
        var therapyDelete = '{{ route('admin.therapyDetailDelete') }}';

        function deletetherapydetail(id) {
            Swal.fire({
                title: "Are you sure?",
