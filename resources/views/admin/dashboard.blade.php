                    ...
                    <div class="row">
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3>{{ isset($TeamCount) ? $TeamCount : 0 }}</h3>
                                ...
                                <a href="{{ route('admin.TeamDetails') }}" class="small-box-footer">More info <i
                        ...
                        <div class="col-lg-4 col-6">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3>{{ isset($TherapyCount) ? $TherapyCount : 0 }}</h3>
                                ...
                                <a href="{{ route('admin.therapys') }}" class="small-box-footer">More info <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3>{{ isset($TreatmentCount) ? $TreatmentCount : 0 }}</h3>
                                ...
                                <a href="{{ route('admin.treatments') }}" class="small-box-footer">More info <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3>{{ isset($BlogCount) ? $BlogCount : 0 }}</h3>
                                    <p>Blog</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-clipboard"></i>
                                </div>
                                <a href="{{ route('admin.BlogDetails') }}" class="small-box-footer">More info <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3> {{ isset($FaqCount) ? $FaqCount : 0 }}</h3>
                                    <p>Faq</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-help-circled"></i>
                                </div>
                                <a href="{{ route('admin.faq') }}" class="small-box-footer">More info <i
                                        class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img"
                                                src="{{ url('/') }}/dist/img/user3-128x128.jpg"
                                                alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ url('/') }}/dist/img/user7-128x128.jpg"
                                                        alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ url('/') }}/dist/img/user5-128x128.jpg"
                                                        alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ url('/') }}/dist/img/user6-128x128.jpg"
                                                        alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="{{ url('/') }}/dist/img/user8-128x128.jpg"
                                                        alt="User Avatar">
