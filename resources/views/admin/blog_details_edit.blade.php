...
<body class="hold-transition sidebar-mini layout-fixed" data-page="edit-blog">
    <div class="wrapper">
                                    ...
                                    <form id="blogForm" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title"
                                                placeholder="Enter Title" value="{{ $blog->name }}">
                                            ...
                                            <select class="form-control" name="category_name[]" id="category_name"
                                                ...
                                                @foreach ($tags as $therapy)
                                                    <option value="{{ $therapy->id }}"
                                                        {{ in_array($therapy->id, explode(',', $blog->category_id)) ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div id="image_preview">
                                                <img class="mt-2" src="{{ Storage::url($blog->image) }}"
    ...
    <script>
        var BlogDetailEditOp = '{{ route('admin.BlogDetailEditOp') }}';
