...
<body class="hold-transition sidebar-mini layout-fixed" data-page="edit-team">
    <div class="wrapper">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit New Team</h3>
                                    ...
                                    <form id="TeamForm" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                value="{{ $team->name }}" id="name" placeholder="Enter Name">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div><img alt="" src="{{ Storage::url($team->image) }}"
                                                    style="width: 200px; height: 100px;"></div>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="position" class="form-label">Position</label>
                                            <input type="text" class="form-control" value="{{ $team->position }}"
    ...
    <script>
        var teamEditOp = '{{ route('admin.teameditOp') }}';
