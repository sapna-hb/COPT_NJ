...
<body class="hold-transition sidebar-mini layout-fixed" data-page="edit-therapydet">
    <div class="wrapper">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Therapy Details</h3>
                                    ...
                                    <form id="treatmentForm" enctype="multipart/form-data">
                                            ...
                                            <select class="form-control" name="therapy_name" id="therapy_name">
                                                ...
                                                @foreach ($therapies as $therapy)
                                                    <option value="{{ $therapy->id }}"
                                                        {{ $therapydetails->therapy_id == $therapy->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="banner_preview">
                                                <img class="mt-2" src="{{ Storage::url($therapydetails->benner) }}"
                                                    style="width: 200px; height: 100px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="description" class="form-label">Description</label>
                                            <div id="description-quill" class="quill-editor">{!! $therapydetails->description !!}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="image_preview">
                                                <img class="mt-2" src="{{ Storage::url($therapydetails->image) }}"
                                                    style="width: 200px; height: 100px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="extra_information" class="form-label">Extra Information</label>
                                            <div id="extra-information-quill" class="quill-editor">
                                                {!! $therapydetails->extra_information !!}
                                            </div>
                                            {{-- <small id="description_error"></small> --}}
                                        </div>
    ...
    <script>
        var therapyDetailEditOp = '{{ route('admin.therapyDetailEditOp') }}';
